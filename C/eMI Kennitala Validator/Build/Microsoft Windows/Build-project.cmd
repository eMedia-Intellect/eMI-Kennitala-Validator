...
msbuild "./eMI Kennitala Validator.msbuild" /p:platform=Win32 /p:configuration=Release

msbuild "./eMI Kennitala Validator.msbuild" /p:platform=x64 /p:configuration=Release