...
all:
	...
	gcc -m32 -pedantic -Wall -Wextra -Wshadow ../../Library/main.c ../../Library/emi_kennitala_validator/validate.c -o ./32-bit/KennitalaValidator

	if [ ! -d ./64-bit/ ]; then mkdir ./64-bit/; fi

	gcc -m64 -pedantic -Wall -Wextra -Wshadow ../../Library/main.c ../../Library/emi_kennitala_validator/validate.c -o ./64-bit/KennitalaValidator
