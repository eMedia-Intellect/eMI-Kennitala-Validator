...
module KennitalaValidator
	...
	def Validate(kennitala)
		...
		if kennitala.length == 10
			if kennitala == '0000000000' || kennitala.match(/\D/)
				return :invalid
			end

			digit1 = kennitala[0].to_i # Birth/Founding day
			digit2 = kennitala[1].to_i # Birth/Founding day
			digit3 = kennitala[2].to_i # Birth/Founding month
			digit4 = kennitala[3].to_i # Birth/Founding month
			digit5 = kennitala[4].to_i # Birth/Founding year
			digit6 = kennitala[5].to_i # Birth/Founding year
			digit7 = kennitala[6].to_i # Random digit
			digit8 = kennitala[7].to_i # Random digit
			digit9 = kennitala[8].to_i # Check digit
			digit10 = kennitala[9].to_i # Century: 8 (1800–1899), 9 (1900–1999), 0 (2000–2099)
